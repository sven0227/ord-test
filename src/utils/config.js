...
const ADDRESS_COUNT =
  NETWORK === MAINNET ?
    process.env.CARDINAL_ADD_COUNT_MAINNET :
    process.env.CARDINAL_ADD_COUNT_TESTNET
const AMOUNT_PER_ADDRESS =
  NETWORK === MAINNET ?
    process.env.AMOUNT_PER_ADDRESS_MAINNET :
    process.env.AMOUNT_PER_ADDRESS_TESTNET
